...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: Because they are in the same function therefore in the same scope
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimalsArray){
    let displayNames = [];
    zooAnimalsArray.forEach((animal) => {return displayNames.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`
    )});
  ...
  */
  ...
  function lowerCaseNames(zooAnimalsArray){
    let lowerCaseArray = zooAnimalsArray.map((animal) => {return animal.animal_name.toLowerCase()});
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimalsArray){
    let lowPopAnimalArray = zooAnimalsArray.filter((animal) => {
      if(animal.population<5){
        return animal;
      }
    })
    return lowPopAnimalArray;
  }
  ...
  */
  ...
  function USApop(zooAnimalsArray){
    let totalUsaAnimalPop = zooAnimalsArray.reduce((sum,animal) => {return sum + animal.population},0);
    return totalUsaAnimalPop;
  }
